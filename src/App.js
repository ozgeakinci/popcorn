...
const Search = ({ query, setQuery }) => {
  ...
  //ref ile sadece dom öğresine erişim sağlamı oluyoruz. Şimdi ona ulaşmak için useEffect kullanmalıyız.
  // ilk render edildiğinde search alanına focus olması için
  useEffect(() => {
    //Bu fonksiyon seçtğimiz inputEl aktif oldığunda içindeki mevcut current elementi seçer.
    //Başka bir noktadayken entera bastığımızda içindeki elemente focus olup silmesini sağlar
    const callback = (e) => {
